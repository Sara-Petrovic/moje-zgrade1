<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
                <form action="/zgrada/{{$zgrada->id}}" method="POST">
                    ...
                    <div class="form-group">
                        <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Sacuvaj zgradu</button>
                    </div>
                    {{ csrf_field() }}
                </form>
            </div>    
